import { Card, Table, TableHead, TableBody, TableRow, TableCell, Chip, Typography, Box } from "@mui/material";
import { AUDIT_LOG } from "@/data/mock";

export default function AuditLogTable() {
  return (
    <Box>
      <Typography sx={{ fontSize: 12, color: "text.faint", mb: 1.5 }}>
        Демо-дані — реальний `GET /audit-logs` ще не підключено (audit_logs у бекенді вже пишеться для login/logout).
      </Typography>
